...
def mine_block():
    ...
    blockchain.add_transactions(node_address, 'Fernandinho', 1)
    block = blockchain.create_block(proof, previous_hash)
    response = {'message': 'Ola imundo', 
                 'index': block['index'], 
...
def connect_node():
    ...
    response = {'message': 'Os nos estao conectados, esta blockchain contem os seguintes nos:', 
...
def repalce_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'As cadeias foram substituidas!',
                    'new_chain': blockchain.chain}
    else:
        response = {'message': 'as cadeias não precisam de substituicao', 
                    'actual_chain': blockchain}
